        ...
        if not cliente.empty:
            ...
            '>
                ...
                <div style='margin-top:10px; font-size:1em; line-height:1.6em; color:#333;'>
                    {estrategia.title()} disponible para tu {producto} terminada en {cuenta}.<br>
                    Selecciona el plazo que más se ajuste a ti.
                </div>
            </div>
            """, unsafe_allow_html=True)
            ...
            if seleccion_cuota != "Selecciona una opción..." and seleccion_cuota != "No estoy interesado":
                ...
                # Mostrar visualmente la confirmación
                st.markdown(f"""
                <div style='
                    margin-top:20px;
                    padding:18px;
